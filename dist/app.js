(()=>{var t={root:document.getElementById("root"),adminOpen:!1,openLetter:null,openPlaceId:null,gallerySearch:"",ytPlayer:null,ytState:-1,ytVol:100,autoPlayNext:!1,selectedPhotos:[],isSelectMode:!1,worldGeoJSON:null,isIOS:/iPad|iPhone|iPod/.test(navigator.userAgent),devMode:localStorage.getItem("devMode")==="true",logs:[]};var B=null;function T(){return B||(B=new Promise((a,o)=>{if(window.L)return a();let e=document.createElement("link");e.rel="stylesheet",e.href="https://unpkg.com/leaflet@1.9.4/dist/leaflet.css",document.head.appendChild(e);let l=document.createElement("script");l.src="https://unpkg.com/leaflet@1.9.4/dist/leaflet.js",l.onload=a,l.onerror=o,document.head.appendChild(l)}),B)}var E=null;function M(){return E||(E=new Promise(a=>{if(window.YT&&window.YT.Player)return a();let o=document.querySelector('script[src*="youtube.com/iframe_api"]'),e=()=>{window.YT&&window.YT.Player?a():setTimeout(e,100)};if(o)e();else{window.onYouTubeIframeAPIReady=()=>a();let l=document.createElement("script");l.src="https://www.youtube.com/iframe_api",document.head.appendChild(l)}}),E)}function z(){try{["map","miniMap"].forEach(a=>{let o=document.getElementById(a);if(o){if(window.echarts){let e=echarts.getInstanceByDom(o);e&&e.dispose()}o._leaflet_map&&(o._leaflet_map.remove(),delete o._leaflet_map)}})}catch{}}var K={heart:'<path d="M12 21s-7-4.5-9.5-9A5.5 5.5 0 0 1 12 6a5.5 5.5 0 0 1 9.5 6c-2.5 4.5-9.5 9-9.5 9z"/>',photo:'<rect x="3" y="5" width="18" height="14" rx="2"/><circle cx="9" cy="11" r="2"/><path d="m21 17-5-5-9 9"/>',letter:'<rect x="3" y="5" width="18" height="14" rx="2"/><path d="m3 7 9 6 9-6"/>',map:'<path d="M9 3 3 5v16l6-2 6 2 6-2V3l-6 2-6-2z"/><path d="M9 3v16M15 5v16"/>',settings:'<circle cx="12" cy="12" r="3"/><path d="M19.4 15a1.7 1.7 0 0 0 .3 1.9l.1.1a2 2 0 1 1-2.8 2.8l-.1-.1a1.7 1.7 0 0 0-1.9-.3 1.7 1.7 0 0 0-1 1.5V21a2 2 0 1 1-4 0v-.1a1.7 1.7 0 0 0-1.1-1.5 1.7 1.7 0 0 0-1.9.3l-.1.1a2 2 0 1 1-2.8-2.8l.1-.1a1.7 1.7 0 0 0 .3-1.9 1.7 1.7 0 0 0-1.5-1H3a2 2 0 1 1 0-4h.1a1.7 1.7 0 0 0 1.5-1.1 1.7 1.7 0 0 0-.3-1.9l-.1-.1a2 2 0 1 1 2.8-2.8l.1.1a1.7 1.7 0 0 0 1.9.3h.1a1.7 1.7 0 0 0 1-1.5V3a2 2 0 1 1 4 0v.1a1.7 1.7 0 0 0 1 1.5 1.7 1.7 0 0 0 1.9-.3l.1-.1a2 2 0 1 1 2.8 2.8l-.1.1a1.7 1.7 0 0 0-.3 1.9v.1a1.7 1.7 0 0 0 1.5 1H21a2 2 0 1 1 0 4h-.1a1.7 1.7 0 0 0-1.5 1z"/>',lock:'<rect x="4" y="11" width="16" height="10" rx="2"/><path d="M8 11V7a4 4 0 0 1 8 0v4"/>',search:'<circle cx="11" cy="11" r="7"/><path d="m21 21-4.3-4.3"/>',plus:'<path d="M12 5v14M5 12h14"/>',trash:'<path d="M3 6h18M8 6V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2m3 0v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6"/>',download:'<path d="M12 3v12m-4-4 4 4 4-4M4 17v2a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-2"/>',upload:'<path d="M12 21V9m-4 4 4-4 4 4M4 17v2a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-2"/>',music:'<path d="M9 18V5l12-2v13"/><circle cx="6" cy="18" r="3"/><circle cx="18" cy="16" r="3"/>',play:'<path d="m5 3 14 9-14 9V3z"/>',pause:'<rect x="6" y="4" width="4" height="16"/><rect x="14" y="4" width="4" height="16"/>',skipBack:'<path d="M19 20 9 12l10-8v16zM5 19V5"/>',skipForward:'<path d="m5 4 10 8-10 8V4zM19 5v14"/>',edit:'<path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/>',volume:'<polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"/><path d="M19.07 4.93a10 10 0 0 1 0 14.14M15.54 8.46a5 5 0 0 1 0 7.07"/>'},u=a=>`<svg viewBox="0 0 24 24" width="1em" height="1em" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">${K[a]}</svg>`;function d(a){return String(a??"").replace(/[&<>"']/g,o=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[o])}function w(a){return a?new Date(a+(a.length===10?"T00:00:00":"")).toLocaleDateString("en-US",{month:"short",day:"numeric",year:"numeric"}):""}function I(a){return a?new Date(a+(a.length===10?"T00:00:00":"")).toLocaleDateString("en-US",{weekday:"long",month:"long",day:"numeric",year:"numeric"}):""}function h(a,{isConfirm:o=!1,isDanger:e=!1}={}){return document.activeElement&&document.activeElement.blur&&document.activeElement.blur(),new Promise(l=>{let c=document.createElement("div");c.className="scrim",c.style.zIndex="9999",c.innerHTML=`
    ...
    `,document.body.appendChild(c);let n=p=>{c.remove(),l(p)},i=null;o&&(i=c.querySelector("[data-c]"),i.onclick=()=>n(!1));let s=c.querySelector("[data-o]");s.onclick=()=>n(!0),i||(i=s),setTimeout(()=>i.focus(),10)})}function U(a){let o=new Date(a+"T00:00:00"),e=new Date,l=e.getFullYear()-o.getFullYear(),c=e.getMonth()-o.getMonth(),n=e.getDate()-o.getDate();if(n<0){c--;let r=new Date(e.getFullYear(),e.getMonth(),0);n+=r.getDate()}c<0&&(l--,c+=12);let i=Math.floor((e-o)/(1e3*60*60*24)),s=new Date(e.getFullYear(),o.getMonth(),o.getDate());s<e&&s.setFullYear(e.getFullYear()+1);let p=Math.ceil((s-e)/(1e3*60*60*24));return{years:l,months:c,days:n,totalDays:i,daysUntilAnniv:p}}function C(a){let o="",e=0;try{let l=new URL(a);l.hostname==="youtu.be"?(o=l.pathname.slice(1),e=parseInt(l.searchParams.get("t"))||0):(o=l.searchParams.get("v"),e=parseInt(l.searchParams.get("t"))||0)}catch{let c=a.match(/v=([^&]+)/)||a.match(/embed\/([^?]+)/);c&&(o=c[1])}return{id:o,start:e}}function P(a){return new Promise((o,e)=>{let l=/iPad|iPhone|iPod/.test(navigator.userAgent),c=l?1e3:1200,n=l?300*1024:500*1024,i=new Image,s=URL.createObjectURL(a);i.onload=()=>{URL.revokeObjectURL(s);let{width:p,height:r}=i;if(p>c||r>c){let N=Math.min(c/p,c/r);p=Math.round(p*N),r=Math.round(r*N)}let m=document.createElement("canvas");m.width=p,m.height=r;let v=m.getContext("2d");v.imageSmoothingEnabled=!0,v.imageSmoothingQuality="high",v.drawImage(i,0,0,p,r);let g=.9,$=m.toDataURL("image/jpeg",g);for(;$.length>n&&g>.3;)g-=.05,$=m.toDataURL("image/jpeg",g);o($)},i.onerror=()=>{if(URL.revokeObjectURL(s),a.size>1024*1024){e(new Error("Image format not supported for compression and file is too large."));return}let p=new FileReader;p.onload=()=>o(p.result),p.onerror=()=>e(p.error),p.readAsDataURL(a)},i.src=s})}function X(){let a=document.createElement("div");a.className="scrim",a.style.zIndex="3000",a.innerHTML=`
  ...
  `,document.body.appendChild(a),Store.getLogs(100).then(o=>{let e=document.getElementById("log-list");if(!o||o.length===0){e.innerHTML="No logs found in cloud.";return}e.innerHTML=o.map(l=>{let c=new Date(l.ts).toLocaleString();return`<div style="margin-bottom:12px; border-bottom:1px solid #222; padding-bottom:8px;">
        ...
        </div>`}).join("")}).catch(o=>{let e=document.getElementById("log-list");e&&(e.innerHTML="Failed to load logs: "+d(o.message))})}function f(){if(document.querySelectorAll(".drawer-scrim, .drawer").forEach(i=>i.remove()),!t.adminOpen)return;let a=Store.get(),o=document.createElement("div");o.className="drawer-scrim",o.style.cssText="position:fixed;inset:0;background:rgba(40,46,30,.35);backdrop-filter:blur(4px);z-index:89",document.body.appendChild(o);let e=document.createElement("div");e.className="drawer open",e.innerHTML=`
    ...
    <div class="drawer-section" style="background:${Store.cloud.connected?"#eaf0e0":"#faf6ed"}">
      ...
      ${Store.cloud.connected?`
        <div class="drawer-actions">
          <button class="btn soft" id="pushCloudBtn">${u("upload")} Push local to cloud</button>
    ...
    <div class="drawer-section">
      ...
      <div class="drawer-actions" style="display:flex; flex-wrap:wrap; gap:8px;">
        <button class="btn soft" id="exportBtn" style="flex:1; min-width:80px; justify-content:center; display:flex; align-items:center; gap:6px; font-size:14px;">${u("download")} Export</button>
        <button class="btn soft" id="logsBtn" style="flex:1; min-width:80px; justify-content:center; display:flex; align-items:center; gap:6px; font-size:14px;">${u("settings")} Logs</button>
        <label class="btn soft" style="flex:1; min-width:80px; cursor:pointer; justify-content:center; display:flex; align-items:center; gap:6px; font-size:14px;">
          ${u("upload")} Import<input type="file" id="importBtn" accept="application/json" style="display:none">
        </label>
      </div>
    </div>
  ...
  `,document.body.appendChild(e),e.querySelector("#devToggle").onchange=i=>{t.devMode=i.target.checked,localStorage.setItem("devMode",t.devMode),q(),f()},o.onclick=()=>{t.adminOpen=!1,f()},e.querySelector("[data-close]").onclick=()=>{t.adminOpen=!1,f()},e.querySelector("#saveCouple").onclick=()=>{Store.setCouple({name1:document.getElementById("aname1").value.trim(),name2:document.getElementById("aname2").value.trim(),motto:document.getElementById("amotto").value.trim()||"our little garden",anniversary:document.getElementById("aanniv").value}),t.adminOpen=!1,f(),y()},e.querySelector("#exportBtn").onclick=()=>Store.exportJSON(),e.querySelector("#logsBtn").onclick=()=>{t.adminOpen=!1,f(),X()};let l=e.querySelector("#connectCloudBtn");l&&(l.onclick=()=>W());let c=e.querySelector("#pushCloudBtn");c&&(c.onclick=()=>Store.pushLocalToCloud());let n=e.querySelector("#disconnectCloudBtn");n&&(n.onclick=async()=>{await h("Disconnect cloud sync? Local data stays.",{isConfirm:!0})&&(await Store.disconnectCloud(),t.adminOpen=!1,f(),setTimeout(()=>{t.adminOpen=!0,f()},50))}),e.querySelector("#importBtn").onchange=async i=>{let s=i.target.files[0];if(s)try{await Store.importJSON(s),alert("imported \u2661"),t.adminOpen=!1,f(),y()}catch(p){alert("import failed: "+p.message)}},e.querySelector("#resetBtn").onclick=async()=>{await h("Really clear everything? This cannot be undone.",{isConfirm:!0,isDanger:!0})&&(Store.resetAll(),t.adminOpen=!1,f(),location.hash="#/home",y())}}function W(){let a=Store.cloud.config||{},o=document.createElement("div");o.className="scrim",o.innerHTML=`
  ...
  <div class="topbar">
    ...
    <div class="topbar-right">
      <button class="icon-btn" id="adminBtn" title="Manage content">${u("settings")}</button>
      <button class="icon-btn" id="lockBtn" title="Lock">${u("lock")}</button>
    </div>
  </div>`}function x(a){return`<nav class="menu-nav">${[["home","Home"],["gallery","Gallery"],["letters","Love Notes"],["map","Our Map"],["playlist","Our Playlist"]].map(([e,l])=>`<a href="#/${e}" class="${a===e?"active":""}">${l}</a>`).join("")}</nav>`}function O(){t.root.innerHTML=`
  ...
  </div>`,document.getElementById("loginForm").addEventListener("submit",a=>{a.preventDefault();let o=document.getElementById("pwd").value.replace(/\D/g,""),e=Store.get().couple.anniversary,[l,c,n]=e.split("-"),i=`${n}${c}${l}`,s=`${l}${c}${n}`,p=`${n}${c}${l.slice(2)}`;o===i||o===s||o===p?(Store.unlock(),location.hash="#/home",y()):(document.getElementById("err").textContent="not quite \u2014 try the date we began",document.getElementById("pwd").value="")})}function j(){let a=Store.get(),o=U(a.couple.anniversary);t.root.innerHTML=`
    ${S()}
    <div class="page">
      ${x("home")}
      <div class="home-hero">
      ...
      <div class="quick-grid">
        ${a.songs.length>0?(()=>{let c=a.songs[Math.floor(Math.random()*a.songs.length)];return`
          <div class="home-playlist-card" id="homeSongCard" data-yt="${d(c.ytUrl||"")}">
            ...
            <div class="hp-play-btn" style="font-size:24px; cursor:pointer; z-index:2" id="homePlayIcon">${u("play")}</div>
        ...
        <a href="#/gallery" class="q-card">
          <div class="qico">${u("photo")}</div>
          <h3>Our Gallery</h3>
          <div class="qc"><span>${a.photos.length} photos</span><span class="qarr">\u2192</span></div>
        </a>
        <a href="#/letters" class="q-card">
          <div class="qico">${u("letter")}</div>
          <h3>Love Notes</h3>
          <div class="qc"><span>${a.letters.length} letters</span><span class="qarr">\u2192</span></div>
        </a>
        <a href="#/map" class="q-card">
          <div class="qico">${u("map")}</div>
          <h3>Our Map</h3>
          <div class="qc"><span>${a.places.length} places</span><span class="qarr">\u2192</span></div>
        </a>
      </div>
    </div>
  `,b();let e=document.getElementById("homeSongCard"),l=document.getElementById("homePlayIcon");if(e&&l){let c=e.dataset.yt;if(c){let n=async()=>{if(t.ytPlayer||(l&&(l.style.opacity="0.5",l.style.cursor="wait"),await M(),!window.YT||!window.YT.Player))return;let i=C(c);i.id&&(t.ytPlayer=new YT.Player("home-yt-frame",{height:"1px",width:"1px",videoId:i.id,host:"https://www.youtube.com",playerVars:{start:i.start,autoplay:1,origin:window.location.origin},events:{onReady:s=>{l&&(l.style.opacity="1",l.style.cursor="pointer"),s.target.setVolume(t.ytVol),s.target.playVideo()},onStateChange:s=>{let p=s.data,r=document.getElementById("homeVinyl");l&&(l.innerHTML=u(p===1?"pause":"play")),r&&r.classList.toggle("playing",p===1)}}}))};l.onclick=i=>{if(i.stopPropagation(),!t.ytPlayer){n();return}t.ytPlayer.getPlayerState&&t.ytPlayer.getPlayerState()===1?t.ytPlayer.pauseVideo():t.ytPlayer.playVideo&&t.ytPlayer.playVideo()},e.onclick=i=>{i.target.closest("#homePlayIcon")||(location.hash="#/playlist")}}else e.onclick=()=>location.hash="#/playlist"}else e&&(e.onclick=()=>location.hash="#/playlist")}function k(){let a=Store.get(),o=t.gallerySearch.toLowerCase(),e=a.photos.filter(s=>!s.placeId&&(!o||(s.caption||"").toLowerCase().includes(o)||(s.date||"").includes(o)));t.root.innerHTML=`
    ${S()}
    <div class="page">
      ${x("gallery")}
      ...
      <div class="gallery-toolbar">
        <div class="search-box">${u("search")}<input type="text" placeholder="search..." id="gsearch" value="${d(t.gallerySearch)}"></div>
        <div style="display:flex;gap:8px">
          ${t.isSelectMode?`<button class="btn soft" id="cancelSelect">Cancel</button><button class="btn" id="bulkDeleteBtn" style="background:#a86060;border-color:#a86060">${u("trash")} Delete (${t.selectedPhotos.length})</button>`:`<button class="btn soft" id="startSelect">${u("heart")} Select</button><button class="btn" id="addPhotoBtn">${u("plus")} Add photo</button>`}
        </div>
      </div>
      ${e.length===0?`<div class="empty"><span class="leaf">\u2766</span>${t.gallerySearch?"no moments match that":"no photos yet"}</div>`:`
        <div class="masonry ${t.isSelectMode?"select-mode":""}">
          ${e.map(s=>{let p=t.selectedPhotos.includes(s.id);return`
              <div class="m-item ${p?"selected":""}" data-photo="${d(s.id)}">
                ${s.url?`<img src="${d(s.url)}" alt="${d(s.caption||"")}" loading="lazy">`:'<div class="m-ph">photo placeholder</div>'}
                <div class="m-sel-check">${p?"\u2713":""}</div>
                ${t.isSelectMode?"":`<button class="m-del" data-del="${d(s.id)}" title="Remove">\xD7</button>`}
                ${s.caption||s.date?`<div class="mcap"><span>${d(s.caption||"")}</span><span class="mdate">${d(w(s.date))}</span></div>`:""}
              </div>
            `}).join("")}
        </div>`}
    </div>
  `,b();let l=document.getElementById("addPhotoBtn");l&&(l.onclick=()=>Q());let c=document.getElementById("startSelect");c&&(c.onclick=()=>{t.isSelectMode=!0,t.selectedPhotos=[],k()});let n=document.getElementById("cancelSelect");n&&(n.onclick=()=>{t.isSelectMode=!1,t.selectedPhotos=[],k()});let i=document.getElementById("bulkDeleteBtn");i&&t.selectedPhotos.length>0&&(i.onclick=async()=>{await h(`Delete ${t.selectedPhotos.length} photos?`,{isConfirm:!0,isDanger:!0})&&(t.selectedPhotos.forEach(s=>Store.removePhoto(s)),t.selectedPhotos=[],t.isSelectMode=!1,k())}),document.getElementById("gsearch").oninput=s=>{t.gallerySearch=s.target.value,k()},t.root.querySelectorAll("[data-photo]").forEach(s=>{s.onclick=p=>{if(p.target.matches("[data-del]"))return;let r=s.dataset.photo;if(t.isSelectMode){let m=s.querySelector(".m-sel-check");t.selectedPhotos.includes(r)?(t.selectedPhotos=t.selectedPhotos.filter(g=>g!==r),s.classList.remove("selected"),m&&(m.textContent="")):(t.selectedPhotos.push(r),s.classList.add("selected"),m&&(m.textContent="\u2713"));let v=document.getElementById("bulkDeleteBtn");v&&(v.innerHTML=`${u("trash")} Delete (${t.selectedPhotos.length})`)}else{let m=Store.get().photos.find(v=>v.id===r);m&&D(m)}}}),t.root.querySelectorAll("[data-del]").forEach(s=>{s.onclick=async p=>{p.stopPropagation(),await h("Remove this photo?",{isConfirm:!0,isDanger:!0})&&(Store.removePhoto(s.dataset.del),k())}})}function Q(a){let o=!!a,e=a||{url:"",caption:"",date:new Date().toISOString().slice(0,10)},l=document.createElement("div");l.className="scrim",l.innerHTML=`
    <div class="dialog">
  ...
  `,document.body.appendChild(l),document.body.classList.add("no-scroll"),l.querySelector("[data-cancel]").onclick=()=>{document.body.classList.remove("no-scroll"),l.remove()},l.querySelector("[data-save]").onclick=async()=>{let c=document.getElementById("purl").value.trim(),n=document.getElementById("pfile").files,i=document.getElementById("pcap").value.trim(),s=document.getElementById("pdate").value;if(!c&&n.length===0){alert("please add a URL or select files");return}let p=l.querySelector("[data-save]");p.textContent="Saving...",p.disabled=!0;try{if(o){let r=c;n.length>0&&(r=await P(n[0])),Store.updatePhoto(e.id,{url:r,caption:i,date:s})}else{c&&Store.addPhoto({url:c,caption:i,date:s});for(let r=0;r<n.length;r++){let m=await P(n[r]);Store.addPhoto({url:m,caption:i,date:s})}}document.body.classList.remove("no-scroll"),l.remove(),y()}catch(r){alert(r.message),p.textContent="Save",p.disabled=!1}}}function D(a){Store.log("debug","opening lightbox",{photoId:a.id}),document.body.classList.add("no-scroll");let o=document.createElement("div");o.className="lightbox",o.innerHTML=`
    <button class="lclose" aria-label="Close">\xD7</button>
    <button class="ldelete" aria-label="Delete">${u("trash")}</button>
    <img src="${d(a.url)}">
    ${a.caption||a.date?`<div class="lcap">${d(a.caption||"")}${a.caption&&a.date?" \xB7 ":""}${d(I(a.date))}</div>`:""}
  ...
  `,document.body.appendChild(l);let c=e.color;l.querySelectorAll(".sw").forEach(n=>n.onclick=()=>{c=n.dataset.color,l.querySelectorAll(".sw").forEach(i=>i.classList.toggle("active",i===n))}),l.querySelector("[data-cancel]").onclick=()=>l.remove(),l.querySelector("[data-save]").onclick=()=>{let n={title:document.getElementById("ltitle").value.trim()||"a little note",from:document.getElementById("lfrom").value.trim(),to:document.getElementById("lto").value.trim(),date:document.getElementById("ldate").value,body:document.getElementById("lbody").value,color:c};o?Store.updateLetter(e.id,n):Store.addLetter(n),l.remove(),t.openLetter=null,y()},o&&(l.querySelector("[data-del]").onclick=async()=>{await h("Delete this note?",{isConfirm:!0,isDanger:!0})&&(Store.removeLetter(e.id),l.remove(),t.openLetter=null,y())})}async function F(){let a=Store.get();if(t.root.innerHTML=`
    ...
    <div class="page">
      ...
      <div style="display:flex;justify-content:flex-end;margin-bottom:16px">
        <button class="btn" id="addPlaceBtn">${u("plus")} Add a place</button>
      </div>
      <div class="map-layout">
        <div id="map"></div>
        <div class="places-list">
          ${a.places.length===0?'<div class="empty" style="padding:40px 20px"><span class="leaf">\u2766</span>no places yet</div>':a.places.sort((s,p)=>new Date(p.date)-new Date(s.date)).map(s=>`
            <div class="place-item" data-place="${d(s.id)}">
              <h4>${d(s.name)}</h4>
              <div class="pd">${d(w(s.date))}</div>
              <div class="pcount">${(s.photos||[]).length+a.photos.filter(p=>p.placeId===s.id).length} photos \u2192</div>
            </div>
          `).join("")}
        </div>
      </div>
    </div>
  `,b(),document.getElementById("addPlaceBtn").onclick=()=>R(),await T(),!window.L){t.root.querySelector("#map").innerHTML='<div class="empty"><span class="leaf">\u2766</span>Map failed to load.</div>';return}let o=document.getElementById("map");if(!o)return;let e=[59.91,10.75],l=L.map(o,{center:e,zoom:3,zoomControl:!1,attributionControl:!1});o._leaflet_map=l,L.tileLayer("https://{s}.basemaps.cartocdn.com/dark_all/{z}/{x}/{y}{r}.png",{}).addTo(l);let c=[...a.places].sort((s,p)=>new Date(s.date)-new Date(p.date)).filter(s=>typeof s.lng=="number"&&typeof s.lat=="number"),n=L.divIcon({className:"custom-marker",html:`
      <div class="pin-wrap">
        <div class="pin-circle"></div>
        <div class="pin-glow"></div>
      </div>
    `,iconSize:[24,24],iconAnchor:[12,12]}),i=[];if(c.forEach(s=>{let p=L.marker([s.lat,s.lng],{icon:n}).addTo(l);p.on("click",()=>{t.openPlaceId=s.id,y()}),p.bindTooltip(`
      <div class="map-tooltip">
        <div class="mt-title">${d(s.name)}</div>
        <div class="mt-date">${w(s.date)}</div>
      </div>`,{direction:"top",offset:[0,-10],opacity:1,className:"premium-tooltip"}),Math.sqrt(Math.pow(s.lat-e[0],2)+Math.pow(s.lng-e[1],2))>.5&&L.polyline([e,[s.lat,s.lng]],{color:"var(--sage)",weight:1.5,opacity:.25,dashArray:"6, 12",smoothFactor:2}).addTo(l),i.push(p)}),L.marker(e,{icon:L.divIcon({className:"home-marker-premium",html:`
        <div class="home-pin">
          <div class="home-icon">${u("heart")}</div>
          <div class="home-glow"></div>
        </div>
      `,iconSize:[36,36],iconAnchor:[18,18]})}).addTo(l).bindTooltip("Home",{direction:"top",className:"premium-tooltip"}),i.length>0){let s=new L.featureGroup([...i,L.marker(e)]);l.fitBounds(s.getBounds().pad(.2))}t.root.querySelectorAll(".place-item").forEach(s=>{s.onclick=()=>{t.openPlaceId=s.dataset.place,y()}}),t.openPlaceId&&A()}function A(a=0){let o=Store.get(),e=o.places.find(r=>r.id===t.openPlaceId);if(!e){t.openPlaceId=null;return}let l=o.photos.filter(r=>r.placeId===e.id),c=e.photos||[],n=document.createElement("div");n.className="scrim",n.innerHTML=`
    <div class="dialog" style="max-width:680px">
      <div class="dialog-header">
        <div class="header-left">
          <div class="eyebrow">${d(I(e.date))}</div>
          <h2 style="margin:0">${d(e.name)}</h2>
        </div>
        <div style="display:flex;gap:8px">
          ${t.isSelectMode?`
            <button class="btn" id="bulkDeletePlaceBtn" style="background:#a86060">${u("trash")} Delete (${t.selectedPhotos.length})</button>
            <button class="btn soft" id="startPlaceSelect">Cancel</button>
          `:`
            <button class="btn soft" id="startPlaceSelect">${u("heart")} Select</button>
      ...
      <div class="place-photos ${t.isSelectMode?"select-mode":""}">
        ${c.map((r,m)=>{let v=`legacy-${m}`,g=t.selectedPhotos.includes(v);return`<div class="pp ${g?"selected":""}" data-ppi="${v}"><img src="${d(r)}" loading="lazy"><div class="m-sel-check">${g?"\u2713":""}</div>${t.isSelectMode?"":`<button class="m-del" data-legacy-ppdel="${m}">\xD7</button>`}</div>`}).join("")}
        ${l.map(r=>{let m=t.selectedPhotos.includes(r.id);return`<div class="pp ${m?"selected":""}" data-ppid="${d(r.id)}"><img src="${d(r.url)}" loading="lazy"><div class="m-sel-check">${m?"\u2713":""}</div>${t.isSelectMode?"":`<button class="m-del" data-ppdel="${d(r.id)}">\xD7</button>`}</div>`}).join("")}
  ...
  `,document.body.appendChild(o),o.querySelector("[data-cancel]").onclick=()=>o.remove(),o.querySelector("[data-save]").onclick=async()=>{let e=document.getElementById("purl").value.trim(),l=document.getElementById("pfile").files;if(!e&&l.length===0){alert("add a URL or select files first");return}let c=o.querySelector("[data-save]");c.textContent="Adding...",c.disabled=!0;try{let n=Store.get().places.find(i=>i.id===a);e&&Store.addPhoto({url:e,caption:n.name,date:n.date,placeId:n.id});for(let i=0;i<l.length;i++){let s=await P(l[i]);Store.addPhoto({url:s,caption:n.name,date:n.date,placeId:n.id})}o.remove(),y()}catch(n){alert(n.message),c.textContent="Add",c.disabled=!1}}}function R(a){let o=!!a,e=a||{name:"",note:"",lat:"",lng:"",date:new Date().toISOString().slice(0,10),photos:[]},l=document.createElement("div");l.className="scrim",l.innerHTML=`
    <div class="dialog">
  ...
  `,document.body.appendChild(l);let c;setTimeout(async()=>{await T();let n=document.getElementById("miniMap");if(!n)return;let i=parseFloat(e.lat)||20,s=parseFloat(e.lng)||0;c=L.map(n,{center:[i,s],zoom:e.lat?5:1,zoomControl:!1,attributionControl:!1}),n._leaflet_map=c,L.tileLayer("https://{s}.basemaps.cartocdn.com/dark_all/{z}/{x}/{y}{r}.png").addTo(c);let p=L.marker([i,s],{icon:L.divIcon({className:"custom-marker small",html:'<div class="pin-wrap"><div class="pin-circle"></div></div>',iconSize:[16,16],iconAnchor:[8,8]})}).addTo(c);c.on("click",r=>{let{lat:m,lng:v}=r.latlng;document.getElementById("nlat").value=m.toFixed(6),document.getElementById("nlng").value=v.toFixed(6),p?p.setLatLng([m,v]):p=L.marker([m,v],{icon:L.divIcon({className:"custom-marker small",html:'<div class="pin-wrap"><div class="pin-circle"></div></div>',iconSize:[16,16],iconAnchor:[8,8]})}).addTo(c)})},50),l.querySelector("#locSearchBtn").onclick=async()=>{let n=document.getElementById("locSearch").value.trim();if(n)try{let s=await(await fetch(`https://nominatim.openstreetmap.org/search?format=json&q=${encodeURIComponent(n)}&limit=1`)).json();if(s&&s.length>0){let p=parseFloat(s[0].lat),r=parseFloat(s[0].lon);document.getElementById("nlat").value=p.toFixed(6),document.getElementById("nlng").value=r.toFixed(6),c&&(c.setView([p,r],5),L.marker([p,r]).addTo(c))}}catch{alert("Search failed")}},l.querySelector("[data-cancel]").onclick=()=>l.remove(),l.querySelector("[data-save]").onclick=async()=>{let n={name:document.getElementById("nname").value.trim(),note:document.getElementById("nnote").value.trim(),date:document.getElementById("ndate").value,lat:parseFloat(document.getElementById("nlat").value),lng:parseFloat(document.getElementById("nlng").value)};o?Store.updatePlace(e.id,n):Store.addPlace(n),l.remove(),t.openPlaceId=null,y()},o&&(l.querySelector("[data-del]").onclick=async()=>{await h("Delete this place?",{isConfirm:!0,isDanger:!0})&&(Store.removePlace(e.id),l.remove(),t.openPlaceId=null,y())})}async function _(){let o=Store.get().songs,e=o[0]||null;t.root.innerHTML=`
    ${S()}
    <div class="page">
      ${x("playlist")}
      ...
      <div class="playlist-main">
        ${e?`
          <div class="now-playing-card">
            ...
            <div class="player-controls">
              <button class="p-btn" id="skipBackBtn">${u("skipBack")}</button>
              <button class="p-btn main" id="playActive">${u("play")}</button>
              <button class="p-btn" id="skipForwardBtn">${u("skipForward")}</button>
            </div>
            <div class="vol-control">${u("volume")}<input type="range" id="volSlider" min="0" max="100" value="${t.ytVol}"></div>
        ...
        <div>
          <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:18px">
            ...
            <button class="btn" id="addSongBtn">${u("plus")} Add song</button>
          </div>
          <div class="song-grid">
            ${o.map(n=>`
              <div class="song-card" data-sid="${d(n.id)}">
                ...
                <h4>${d(n.title)}</h4>
                <p>${d(n.artist)}</p>
                <button class="m-edit" data-sedit="${d(n.id)}">${u("edit")}</button>
  ...
  `,b();let l=document.getElementById("playActive");if(l&&((!t.ytPlayer||typeof t.ytPlayer.playVideo!="function")&&(l.style.opacity="0.5",l.style.cursor="wait"),l.onclick=()=>{if(Store.log("debug","Play button clicked",{hasPlayer:!!t.ytPlayer,ytState:t.ytState}),!t.ytPlayer||typeof t.ytPlayer.playVideo!="function"){Store.log("debug","Player not ready, setting autoPlayNext"),t.autoPlayNext=!0;return}t.ytState===1?(Store.log("debug","Pausing video"),t.ytPlayer.pauseVideo()):(Store.log("debug","Playing video"),t.ytPlayer.playVideo())}),e&&e.ytUrl)if(Store.log("debug","Loading YouTube API",{url:e.ytUrl}),await M(),window.YT&&window.YT.Player){let n=C(e.ytUrl);if(Store.log("debug","Parsed YouTube URL",n),n.id){if(t.ytPlayer){Store.log("debug","Destroying existing player");try{t.ytPlayer.destroy()}catch{}t.ytPlayer=null,t.ytState=-1}Store.log("debug","Creating new YT.Player",{videoId:n.id}),t.ytPlayer=new YT.Player("yt-player-frame",{height:"1px",width:"1px",videoId:n.id,host:"https://www.youtube.com",playerVars:{start:n.start,autoplay:t.autoPlayNext?1:0,origin:window.location.origin,enablejsapi:1},events:{onReady:i=>{Store.log("debug","Player onReady",{autoPlayNext:t.autoPlayNext}),l&&(l.style.opacity="1",l.style.cursor="pointer"),i.target.setVolume(t.ytVol),t.autoPlayNext&&(t.autoPlayNext=!1,i.target.playVideo())},onStateChange:i=>{Store.log("debug","Player onStateChange",{newState:i.data}),t.ytState=i.data;let s=document.querySelector(".player-cover-wrap");l&&(l.innerHTML=u(t.ytState===1?"pause":"play")),s&&s.classList.toggle("playing",t.ytState===1),t.ytState===0&&(Store.log("debug","Video ended, skipping to next"),document.getElementById("skipNextBtn").click())},onError:i=>{Store.log("error","YouTube Player Error",{errorCode:i.data})}}})}}else Store.log("error","YouTube API loaded but YT.Player not found");document.getElementById("skipBackBtn").onclick=()=>{o.length<2||(t.autoPlayNext=!1,Store.set(n=>{let i=n.songs.pop();n.songs.unshift(i)}),y())},document.getElementById("skipForwardBtn").onclick=()=>{o.length<2||(t.autoPlayNext=!1,Store.set(n=>{let i=n.songs.shift();n.songs.push(i)}),y())};let c=document.getElementById("volSlider");c&&(c.oninput=n=>{t.ytVol=parseInt(n.target.value),t.ytPlayer&&t.ytPlayer.setVolume&&t.ytPlayer.setVolume(t.ytVol)}),document.getElementById("addSongBtn").onclick=()=>Y(),document.querySelectorAll("[data-sedit]").forEach(n=>{n.onclick=i=>{i.stopPropagation();let s=o.find(p=>p.id===n.dataset.sedit);s&&Y(s)}}),document.querySelectorAll(".song-card").forEach(n=>{n.onclick=i=>{if(i.target.closest(".m-del")||i.target.closest(".m-edit"))return;let s=n.dataset.sid,p=o.find(r=>r.id===s);if(p){t.autoPlayNext=!1;let r=o.filter(m=>m.id!==s);Store.set(m=>{m.songs=[p,...r]}),y()}}}),document.querySelectorAll("[data-sdel]").forEach(n=>{n.onclick=async i=>{i.stopPropagation(),await h("Remove this song?",{isConfirm:!0,isDanger:!0})&&(Store.removeSong(n.dataset.sdel),y())}})}function Y(a=null){let o=!!a,e=document.createElement("div");e.className="scrim",e.innerHTML=`
    <div class="dialog">
  ...
  `,document.body.appendChild(e),document.getElementById("saveSongBtn").onclick=async()=>{let l=document.getElementById("stitle").value,c=document.getElementById("sartist").value,n=document.getElementById("syt").value,i=document.getElementById("scover").files[0];if(!l||!c)return alert("Please enter title and artist");let s=document.getElementById("saveSongBtn");s.disabled=!0,s.textContent="Saving...";try{let p=a?a.cover:'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="100" height="100"><rect width="100" height="100" fill="%23eee"/><text x="50%" y="50%" dominant-baseline="middle" text-anchor="middle" font-size="40">\u{1F3B5}</text></svg>';i&&(p=await P(i));let r={title:l,artist:c,ytUrl:n,cover:p};o?Store.updateSong(a.id,r):Store.addSong(r),e.remove(),y()}catch{alert("Failed to process image"),s.disabled=!1}}}window.onerror=(a,o,e,l,c)=>{Store.log("error",a,{url:o,line:e,col:l,stack:c?c.stack:null})};window.onunhandledrejection=a=>{Store.log("promise_error",a.reason?a.reason.message:"unknown",{stack:a.reason?a.reason.stack:null})};function G(){let a=location.hash.replace("#/","")||"home",[o,...e]=a.split("/");return{path:o,params:e}}window.addEventListener("hashchange",y);function J(){let a=document.getElementById("skeletonLoader");a&&!a.classList.contains("hidden")&&(setTimeout(()=>a.classList.add("hidden"),500),setTimeout(()=>a.remove(),1e3))}async function y(){let a=G();if(Store.log("debug","Rendering route: "+a.path),z(),t.ytPlayer){try{t.ytPlayer.destroy()}catch{}t.ytPlayer=null,t.ytState=-1}if(document.querySelectorAll(".scrim").forEach(l=>l.remove()),!Store.get().session.unlocked){O(),J();return}switch(G().path){case"home":j();break;case"letters":H();break;case"gallery":k();break;case"map":await F();break;case"playlist":await _();break;default:location.hash="#/home"}J()}window.state=t;Store.init().then(()=>{y(),q()});})();
